<template>
    <v-app>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top d-flex justify-content-end py-4">
            <div id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <v-btn text dark @click="$router.push({name: 'login'})">Sign In</v-btn>
                    </li>
                    <li class="nav-item">
                        <v-btn color="#ab97f3" class="ml-3" dark>Download
        ...
        <v-card flat min-height="470px"
                class="position-relative overflow-hidden text-center bg-light d-flex flex-column justify-center">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 d-flex align-start flex-column justify-center">
                    <h2 class="">What we’re about. <span
                        class="text-muted">For your information.</span></h2>
                    <p class="lead">
