  ...
  <div class="card">
    <div class="card-header border-0">
      <div class="d-flex justify-content-center">
        <h3 class="card-title">Weekly/Daily Purchase Report</h3>
      </div>
    </div>
    <div class="card-body mt-5">
      ...
      <div class="d-flex">
        <p class="d-flex flex-column">
          <span class="text-bold text-lg">
            <v-icon>mdi-cart-variant</v-icon>{{ payload.interactions }}</span
          >
      ...
      <div class="position-relative mb-4">
        <canvas id="weeklySold-chart" height="300"></canvas>
      </div>
...
export default {
  ...
  methods: {
    ...
    async setup() {
      ...
      var mode = "index";
      var intersect = true;
      var $salesChart = $("#weeklySold-chart");
