  ...
  <div>
    ...
    <v-dialog v-model="stockDialog" max-width="600px" persistent>
      <v-card>
            ...
            <v-row>
              <v-col cols="12">
                <v-text-field
                  ...
                  :error-messages="stockForm.errors.get('quantity')"
                ...
                <v-textarea
                  ...
                  :error-messages="stockForm.errors.get('remarks')"
                  label="Remarks"
                  rows="3"
                />
              </v-col>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="blue darken-1" text @click="stockDialog = false">
            Close
          </v-btn>
          <v-btn
            color="blue darken-1"
            ...
            <v-row>
              ...
              <v-col cols="12">
                <v-text-field
                  ...
                  :error-messages="form.errors.get('preparation_time')"
