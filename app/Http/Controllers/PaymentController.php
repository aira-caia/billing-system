...
class PaymentController extends Controller
{
    ...
    public function orders(Request $request)
    {
        ...
        if ($request->is_served == "1") {
            $payments = PaymentResource::collection(Payment::orderByDesc("id")->whereDate('created_at', '>', Carbon::today()->subDays(1))->where("is_served", 1)->groupBy("order_code", 'is_served', 'created_at')->get());
            ...
            $payments = PaymentResource::collection(Payment::orderByDesc("id")->whereDate('created_at', '>', Carbon::today()->subDays(1))->groupBy("order_code", 'is_served', 'created_at')->get());
        }
        // return ['data' => []];
        return $payments;
    }
